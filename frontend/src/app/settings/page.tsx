  ...
  return (
    <LayoutWrapper>
      <div className="max-w-[620px] mx-auto">
        ...
        <h1 className="font-display text-[32px] tracking-tight mb-8 text-foreground font-medium">Settings</h1>
          ...
          <form onSubmit={handleSave} className="space-y-5">
            ...
            <div className="pt-2 border-t border-border">
              ...
              <div className="flex items-center gap-3 mb-1">
                ...
                <span className="font-mono text-[13px] text-foreground/70">{user.email}</span>
              </div>
            </div>
        ...
        {/* Stats section */}
        <div className="mt-6 stamp-card p-5 bg-background/60">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            {[
              ...
              <div key={s.label}>
                ...
                <div className="font-mono text-[14px] text-foreground font-bold">{s.value}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-6 stamp-card p-5 bg-background/60">
          <div className="flex items-center justify-between">
            <div>
              <div className="font-display text-[15px] font-medium text-foreground mb-1">Theme Preference</div>
              <div className="text-[13px] text-foreground/60">Toggle between light, dark, and system themes.</div>
            </div>
            <ThemeToggle />
          </div>
        </div>
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className={
          "w-full h-10 px-3 bg-background border border-border focus:border-blueprint focus:outline-none text-[14px] transition-colors " +
